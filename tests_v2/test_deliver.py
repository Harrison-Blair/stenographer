...
"""Pure-logic tests for deliver.py: chord_events() ordering only.

The wl-copy round trip and the uinput device are covered by the integration
smoke suite in test_deliver_smoke.py — nothing here mocks subprocess/UInput (§6).
"""

from __future__ import annotations

from stenographer_v2.deliver import _INSERT, _SHIFT, chord_events
