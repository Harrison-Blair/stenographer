...
This is contributor and release documentation. For installation and everyday
use, see the [README](../README.md) and [user guide](usage.md).
...
See [cue-audition.md](cue-audition.md) for generation provenance and
