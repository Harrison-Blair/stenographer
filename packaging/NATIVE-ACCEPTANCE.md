...
keyboard, clipboard, service behavior, accessibility, the fixed dark appearance
under both system themes, scaling, and crash-isolation checks for each supported
target. macOS Intel and
