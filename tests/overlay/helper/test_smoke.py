...
from stenographer.overlay.protocol.messages import CommandMessage, ReadyMessage, UnavailableMessage
...
def test_frozen_private_overlay_responds_and_logs_to_its_own_file(tmp_path):
    executable = Path(__file__).parents[3] / "dist" / "stenographer" / "stenographer"
