...
from stenographer.setup_config import ConfigDocument, ConfigPersistenceError
...
def _automatic_floor(console: _Console, config: Config, current: float) -> float:
    from stenographer.calibration import CalibrationError, calibrate_spectrum_floor
...
def _guided_setup(
    ...
    *,
    ...
    from stenographer import doctor, model
